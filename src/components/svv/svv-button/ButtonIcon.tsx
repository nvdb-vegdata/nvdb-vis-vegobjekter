...
import type { ButtonIconType } from './Button.types'
import { useButtonTestId } from './test-parts'

export const SVVButtonIcon = forwardRef<HTMLButtonElement, ButtonIconType>(function ButtonInternal(
  props: ButtonIconType,
  ref: ForwardedRef<HTMLButtonElement>,
) {
  const { square, size = 'sm', ariaLabel, icon, className, loading, loadingString, testId, ...restProps } = props
