import type { AnchorHTMLAttributes, ButtonHTMLAttributes, ElementType, HTMLAttributes, ReactElement } from 'react'
...
export type ButtonCustomType = ({ asElement: any; hrefAttribute: string } | { asElement?: never; hrefAttribute?: never }) &
  BaseButtonType &
