...
import type { ButtonCustomType } from './Button.types'
 ...
 */
export const SVVButtonCustom = forwardRef<HTMLButtonElement | HTMLAnchorElement, ButtonCustomType>(function ButtonInternal(
