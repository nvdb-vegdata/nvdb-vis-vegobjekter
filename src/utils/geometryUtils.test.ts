...
describe("getClippedGeometries", () => {
  test("returns clipped geometry for point stedfesting within veglenke range", () => {
    const veglenkesekvenser: VeglenkesekvensMedPosisjoner[] = [{
      id: 605710,
      veglenker: [
        { nummer: 19, startposisjon: 0.3552159, sluttposisjon: 0.39458101 } as any,
      ],
    } as any];

    const stedfesting: StedfestingPunkter = {
      type: "StedfestingPunkter",
      punkter: [{ id: 605710, posisjon: 0.3880223, retning: "MED", sideposisjon: "V", kjorefelt: [] }],
    };
  ...
  test("returns empty for point stedfesting outside veglenke range", () => {
    const veglenkesekvenser: VeglenkesekvensMedPosisjoner[] = [{
      id: 605710,
      veglenker: [
        { nummer: 19, startposisjon: 0.5, sluttposisjon: 0.6 } as any,
      ],
    } as any];
  ...
  test("returns empty for point stedfesting on different veglenkesekvens", () => {
    const veglenkesekvenser: VeglenkesekvensMedPosisjoner[] = [{
      id: 999999,
      veglenker: [
        { nummer: 1, startposisjon: 0, sluttposisjon: 1 } as any,
      ],
    } as any];

    const stedfesting: StedfestingPunkter = {
      type: "StedfestingPunkter",
      punkter: [{ id: 605710, posisjon: 0.5, retning: "MED", sideposisjon: "V", kjorefelt: [] }],
    };
